...
| 캐나다 로키 현지 교통 | EXPECTED_BLOCK | PASS | EXPECTED_BLOCK | PASS | PASS/PASS | PASS | PASS | published | PASS |
...
| 다낭 여행 일정 | EXPECTED_BLOCK | PASS | EXPECTED_BLOCK | PASS | PASS/PASS | PASS | PASS | published | PASS |
