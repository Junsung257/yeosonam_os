...
Historical raw worktree patches and 2026-08-23 production inventory dumps were
excluded from the integration PR. They are stale, non-reproducible, and
secret-scanner-hostile inputs, not runtime dependencies. Phase 5 must regenerate
its inventory and evidence from the reviewed release SHA and a single current
capture time.
