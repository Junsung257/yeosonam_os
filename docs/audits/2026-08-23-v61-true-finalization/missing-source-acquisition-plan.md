...
Generated: 2026-08-23T07:51:00.746Z

## Boundary

The full corpus has 1058 missing source rows and 16 hash-mismatch/corrupted rows. This plan does not claim that all rows are needed to form a 400-section Gold; it records the full recovery queue and a metadata-only P0 coverage projection.

## Exact external inputs required

- Missing original source bytes: 1058 rows.
- Manual reconciliation for hash-mismatch/corrupt candidates: 16 rows.
- Lower-bound metadata projection to reach 400 verified sections: 31 additional rows / 209 sections.
...
|---|---:|---:|
| SUPPLIER_UNPROVEN \| travel_product \| development | 535 | 1013 |
| SUPPLIER_UNPROVEN \| travel_product \| calibration | 133 | 256 |
| SUPPLIER_UNPROVEN \| travel_product \| frozen | 116 | 220 |
| SUPPLIER_UNPROVEN \| non_travel \| frozen | 29 | 0 |
| SUPPLIER_UNPROVEN \| non_travel \| calibration | 18 | 0 |
| SUPPLIER_UNPROVEN \| non_travel \| development | 103 | 0 |
