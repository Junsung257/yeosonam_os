...
const commands = [
  {
    ...
    args: [
      ...
      'src/lib/product-registration-v6/learning-loop.test.ts',
      'src/lib/product-registration/future-departure-date-policy.test.ts',
      'src/lib/parser/deterministic/price-ir/explicit-date-weekday-price.test.ts',
