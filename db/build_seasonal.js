...
// ─── destination별 검색 키워드 매핑 (SSOT) ─────────────────────────
// primary_city + 동의어 (한국인이 검색할만한 표기들).
// 단일 소스: src/lib/seasonal-keyword-map.json — /api/cron/refresh-seasonal 과 공유.
// 신규 destination 추가 시 JSON 한 곳만 수정하면 양쪽에 반영됨.
const KEYWORD_MAP = require('../src/lib/seasonal-keyword-map.json');
