-- Content pipeline and blog telemetry tables are operated through server APIs.
-- Keep direct browser-key access closed so automation data, drafts, mappings,
-- and engagement signals cannot be read or mutated outside guarded routes.
