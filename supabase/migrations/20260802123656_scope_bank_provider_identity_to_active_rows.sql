...
DROP INDEX CONCURRENTLY IF EXISTS public.uq_bank_transactions_external_provider_tx;

CREATE UNIQUE INDEX CONCURRENTLY uq_bank_transactions_external_provider_tx
