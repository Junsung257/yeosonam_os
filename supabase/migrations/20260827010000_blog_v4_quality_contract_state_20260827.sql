-- Keep the persisted V4 operation projection in sync with the final quality
-- decision emitted by the fenced stage-event writer. The legacy RPC updated
-- current_stage/status but left the V4 state columns at their defaults.
