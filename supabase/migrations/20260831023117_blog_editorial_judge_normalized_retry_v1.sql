-- Allow one final, separately ledgered semantic-judge retry after parser
-- normalization. Article generation remains untouched and every judge call
-- stays under the same atomic KST-day cost cap.
...
comment on constraint blog_ai_budget_reservations_call_kind_check
  ...
  'Separates article generation and bounded editorial-judge recovery calls under one shared daily cap.';
