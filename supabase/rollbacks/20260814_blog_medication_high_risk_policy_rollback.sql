-- Rollback for 20260814033000_blog_medication_high_risk_policy.sql.
-- Restores the exact high-risk evaluator policy shipped by
-- 20260811132017_blog_quality_v3_policy.sql. No rows are mutated.
...
comment on function public.evaluate_blog_public_eligibility_v3 is
  'Canonical SQL half of Blog Quality V3 public eligibility. Keep parity with src/lib/blog-public-eligibility.ts fixtures.';
