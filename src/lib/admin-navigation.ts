...
export const adminNavGroups: NavGroup[] = [
    ...
    items: [
      {
        ...
        searchKeywords: ['Clobe 동기화', '클로브 메모', '입금 매칭', '미매칭 입금', '출금 승인', '고객 환불', '최종 정산', '월 마감', '회사 경비', '세금', '통합 장부', 'bank transaction'],
      },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/admin/marketing/media', label: 'AI 미디어 검수', icon: Camera, minRole: 'tenant_admin' },
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/admin/agent-mas',
        label: 'AI 운영실',
        icon: GitBranch,
        minRole: 'platform_admin',
        searchKeywords: ['Agent Office', 'MAS 관제', 'Shadow', '읽기 전용', '운영실'],
      },
