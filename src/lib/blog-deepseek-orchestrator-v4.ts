...
export function buildDeepSeekRewritePromptV4(input: {
  ...
  return [
    ...
    ...(packet ? [
      ...
      '- Use one short H2 section per approved claim. After each exact claim and citation, add 1-2 questions that help the reader compare that verified fact with their own time, mobility, and companions.',
      ...
      '- Finish with one question-form H2 and a Markdown bullet list of 3-5 reader-choice questions. Questions must not imply unapproved facts.',
