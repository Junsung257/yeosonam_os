...
export const ACTION_REGISTRY = {
  ...
  adjust_mileage: entry({
    actionType: 'adjust_mileage',
    agentType: 'marketing',
    title: 'Adjust customer mileage',
    description: 'Manually add or deduct customer mileage.',
    riskLevel: 'high',
    requiredPayloadKeys: ['customer_id', 'delta', 'reason'],
    requiredEvidence: ['customer id', 'delta amount', 'operator reason'],
    predictedEffects: ['customer mileage balance can change', 'mileage transaction is inserted'],
    rollbackHint: 'Apply a compensating mileage transaction and retain both audit entries.',
  }),
  create_mileage_event: entry({
    actionType: 'create_mileage_event',
    agentType: 'marketing',
    title: 'Create mileage event',
    description: 'Create a mileage campaign or policy event.',
    riskLevel: 'high',
    requiredPayloadKeys: ['title', 'action_type', 'action_config'],
    requiredEvidence: ['policy title', 'action config', 'operator reason'],
    predictedEffects: ['mileage policy or event can become active'],
    rollbackHint: 'Deactivate or supersede the mileage policy/event.',
  }),
