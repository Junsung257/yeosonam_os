...
const INTENT_NEIGHBORS: Record<BlogInformationIntent, ReadonlySet<BlogInformationIntent>> = {
  ...
  monthly_weather: new Set(['itinerary', 'airport_transport', 'local_transport', 'general']),
  airport_transport: new Set(['local_transport', 'hotel_areas', 'itinerary', 'monthly_weather', 'general']),
  local_transport: new Set(['airport_transport', 'hotel_areas', 'itinerary', 'monthly_weather', 'general']),
  hotel_areas: new Set(['airport_transport', 'local_transport', 'family_budget', 'itinerary', 'general']),
  family_budget: new Set(['food_budget', 'hotel_areas', 'currency_payment', 'itinerary', 'general']),
  itinerary: new Set(['family_budget', 'hotel_areas', 'airport_transport', 'local_transport', 'monthly_weather', 'general']),
