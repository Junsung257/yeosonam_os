...
import type { V3DraftLedger, V3GateCheck, V3GateResult, V3StructurePlan } from './types';
...
export function evaluateProductRegistrationV3Gate(plan: V3StructurePlan, ledger: V3DraftLedger): V3GateResult {
