...
export default function GroupLandingPage() {
  return (
    <main className="min-h-screen bg-white text-slate-900">
      {/* ─── 섹션 A. Hero ──────────────────────────────────── */}
      <section className="relative bg-gradient-to-br from-[#340897] to-[#4b2ead] text-white">
        <div className="max-w-4xl mx-auto px-4 py-20 md:py-28">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <a
              ...
              className="flex-1 bg-white text-[#340897] font-bold py-4 px-6 rounded-2xl text-center hover:bg-white/90 transition"
            >
              견적 요청하기
            </a>
            <a
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {GROUP_TYPES.map((g) => (
              <a
                ...
                className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:border-[#340897]/30 transition"
              >
                <div className="text-4xl mb-3">{g.icon}</div>
                <h3 className="font-bold text-lg mb-1 group-hover:text-[#340897] transition">
                  {g.title}
                </h3>
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {PROCESS_STEPS.map((p, i) => (
              <div key={p.step} className="relative">
                <div className="bg-gradient-to-br from-[#340897]/5 to-[#4b2ead]/5 rounded-2xl p-5 border border-[#340897]/10 h-full">
                  <div className="text-xs font-bold text-[#340897] mb-2">{p.step}</div>
                ...
                {i < PROCESS_STEPS.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 text-[#340897]/30 text-xl">
                    →
                  </div>
                )}
              </div>
      ...
      {/* ─── 섹션 G. 하단 CTA ───────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#340897] to-[#4b2ead] text-white py-16 md:py-20 px-4">
