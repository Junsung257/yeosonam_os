        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="홍길동"
              className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#340897] focus:border-transparent transition"
              required
            />
          </div>
                ...
                <button
                  ...
                  className={`py-2.5 rounded-xl text-sm font-semibold transition border ${
                    form.hotel_grade === h
                      ...
                      : 'bg-white text-slate-700 border-gray-200 hover:border-[#340897]/40'
                  }`}
                >
                  {h}
                </button>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#340897] focus:border-transparent transition resize-none"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#340897] hover:bg-[#4b2ead] disabled:bg-slate-400 text-white font-bold py-4 rounded-2xl text-lg transition"
          >
