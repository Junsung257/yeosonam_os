            ...
            <div className="flex flex-col items-center flex-1">
              ...
              <span
                className={`text-xs mt-1 whitespace-nowrap ${
                  isActive ? 'text-brand font-semibold' : isPending ? 'text-gray-400' : 'text-green-600'
                }`}
              >
                {step.label}
              </span>
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        {/* 헤더 */}
        <div>
          <Link href="/" className="text-sm text-brand hover:underline">← 홈으로</Link>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                    ...
                    <div>
                      ...
                      <span className="font-bold text-brand">{p.ai_review?.score ?? '—'}/100</span>
                    </div>
                  </div>
