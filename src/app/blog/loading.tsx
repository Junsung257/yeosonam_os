export default function Loading() {
  return (
    <div className="min-h-screen bg-white animate-pulse">
      ...
      {/* Hero header */}
      <div className="bg-gradient-to-br from-[#1B3A6B] to-brand py-12 px-4">
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Large featured */}
          <div className="md:col-span-2 rounded-2xl overflow-hidden border border-admin-border">
            <div className="aspect-[16/9] bg-brand-light" />
            <div className="p-4 space-y-2">
              <div className="h-4 w-16 rounded-full bg-brand-light" />
              <div className="h-5 w-4/5 rounded bg-blue-100" />
              <div className="h-5 w-3/5 rounded bg-blue-100" />
              <div className="h-3.5 w-2/5 rounded bg-bg-section" />
            </div>
          </div>
          {/* 2 stacked */}
          <div className="flex flex-col gap-4">
            {[0, 1].map(i => (
              <div key={i} className="flex-1 rounded-2xl overflow-hidden border border-admin-border">
                <div className="aspect-[16/9] bg-brand-light" />
        ...
        <div className="flex gap-2 flex-wrap">
          {[52, 44, 56, 48, 44, 60, 52, 44].map((w, i) => (
            <div key={i} className="h-7 rounded-full bg-bg-section" style={{ width: w }} />
          ))}
        </div>
            ...
            <div key={i} className="rounded-2xl overflow-hidden border border-admin-border">
              ...
              <div className="p-4 space-y-2">
                <div className="flex gap-2">
                  ...
                  <div className="h-5 w-14 rounded-full bg-bg-section" />
                </div>
