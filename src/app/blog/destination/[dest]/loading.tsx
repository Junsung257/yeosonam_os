export default function Loading() {
  return (
    <div className="min-h-screen bg-white animate-pulse">
      ...
      <header className="bg-gradient-to-r from-[#3182F6] to-[#1B64DA] py-14 md:py-20 px-4">
        <div className="mx-auto max-w-6xl space-y-3">
          ...
          <div className="h-10 md:h-14 w-44 rounded-lg bg-white/25" />
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 py-12 space-y-10">
        ...
        <div className="space-y-3">
          <div className="h-5 w-40 rounded bg-[#DBEAFE]" />
