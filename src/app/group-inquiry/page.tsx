      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className="max-w-2xl mx-auto space-y-4">
          {messages.map((msg, idx) => (
            ...
            >
              {msg.role === 'ai' && (
                <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-sm mr-2 mt-1 flex-shrink-0">
                  🤖
                </div>
              )}
              <div
          ...
          {/* RFQ 요약 카드 */}
          {rfqReady && (
            <div className="bg-white border border-indigo-200 shadow-sm rounded-xl p-5 mt-4">
