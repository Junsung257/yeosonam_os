      ...
      <section className="p-5 bg-white border border-slate-200 rounded-xl space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 text-[13px] border border-slate-200 rounded-lg focus:outline-none focus:border-brand"
          />
        </div>
        <div>
          <label className="block text-[13px] font-semibold text-slate-700 mb-1.5">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 text-[13px] border border-slate-200 rounded-lg focus:outline-none focus:border-brand resize-none"
          />
