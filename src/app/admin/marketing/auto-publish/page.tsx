                  ...
                  {suggestions.map((s) => (
                    <li key={s.id}>
                      <button
                        ...
                        className="w-full px-4 py-3 text-left hover:bg-slate-800 cursor-pointer transition-colors flex flex-col"
                      >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div className="flex items-center gap-3 bg-slate-900/30 border border-slate-800 hover:border-slate-700 rounded-admin-md p-4 transition-all">
                  ...
                  />
                  <label htmlFor="auto-publish-dry-run" className="cursor-pointer">
                ...
                <div className="flex items-center gap-3 bg-slate-900/30 border border-slate-800 hover:border-slate-700 rounded-admin-md p-4 transition-all">
                  <input
                    ...
                    className="w-4 h-4 accent-emerald-500 text-emerald-500 rounded"
                  />
                  <label htmlFor="auto-publish-publish-now" className="cursor-pointer">
