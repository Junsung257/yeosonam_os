                    ...
                    {config && (
                      <>
                        <div className="flex items-center gap-2">
                          <label htmlFor={`daily-limit-${platform}`} className="text-[10px] text-gray-400">일일한도</label>
                          <input
                            id={`daily-limit-${platform}`}
                            type="number"
                        ...
                        <button type="button"
                          ...
                          aria-label={`${info.label} 자동 발행 ${config?.enabled ? '끄기' : '켜기'}`}
