    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-admin-md border border-admin-border shadow-[0_1px_4px_rgba(0,0,0,0.04)] p-4 space-y-3">
        ...
        {postType === 'product' ? (
          ...
          {bulkCount > 1 && (
            <p className="text-[11px] text-admin-muted bg-amber-50 border border-amber-200 rounded px-2.5 py-1.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3" style={{ minHeight: '500px' }}>
        ...
        {/* 우: 미리보기 */}
        <div className="flex flex-col">
          <div className="flex items-center px-3 py-1.5 bg-admin-bg border border-admin-border-mid rounded-t-lg">
          ...
          <div className="flex-1 border border-t-0 border-admin-border-mid rounded-b-lg p-4 overflow-y-auto bg-white">
            {previewHtml ? (
              ...
              <p className="text-admin-sm text-admin-muted-2 italic">AI 생성 또는 직접 작성하면 미리보기가 표시됩니다</p>
            )}
          </div>
        </div>
      </div>
