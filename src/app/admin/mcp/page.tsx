      ...
      <div className="bg-white border rounded-lg p-4 mb-6">
        ...
        <div className="flex flex-wrap gap-3 items-end">
          <div className="flex-1 min-w-[200px]">
            <label htmlFor="mcp-token-label" className="block text-xs text-gray-500 mb-1">키 설명</label>
            <input
              id="mcp-token-label"
              type="text"
              value={newLabel}
          ...
          <div>
            <label htmlFor="mcp-token-role" className="block text-xs text-gray-500 mb-1">권한</label>
            <select
              id="mcp-token-role"
              value={newRole}
