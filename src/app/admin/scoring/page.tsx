    ...
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <section className="bg-admin-surface rounded-admin-md border border-admin-border-mid shadow-admin-xs p-5 space-y-4">
        ...
        <div className="flex gap-2 items-end">
          ...
          <div className="w-32">
            <label htmlFor="scoring-rate-value" className="block text-xs text-admin-muted mb-1">시장가 (KRW)</label>
            <input id="scoring-rate-value" type="number" min={0} step={10000} value={newRateValue}
