  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="admin-card p-4 mb-4">
        <label htmlFor="booking-guide-package-select" className="block text-admin-xs text-admin-text-2 font-medium mb-1.5">상품 선택</label>
        <select
          id="booking-guide-package-select"
          value={selectedPkgId}
